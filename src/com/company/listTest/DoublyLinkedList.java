...
interface DoublyLinkedList<T> {
     ...
     */
    boolean insert(T data, int position);
    ...
    /**
     * EN: Returns first element from the list.
     * PL: Zwraca pierwszy element z listy.
     *
     * @return first element of the list (element listy)
     */
    T getFirst();

    /**
     * EN: Returns last element from the list.
     * PL: Zwraca ostatni element z listy.
     *
     * @return last element of the list (element listy)
     */
    T getLast();
